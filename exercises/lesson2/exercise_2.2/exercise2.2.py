...
def create_topic(client, topic_name):
    ...
    # Create the topic. Make sure to set the topic name, the number of partitions, the replication factor.
    # Additionally, set the config to have:
    #   a cleanup policy of delete
    #   a compression type of lz4
    #   a delete retention milliseconds of 2 seconds
    #   a file delete delay milliseconds of 2 second
...
def main():
    ...
    topic_name = "com.udacity.lesson2.exercise2.topics"
