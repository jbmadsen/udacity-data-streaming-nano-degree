...
class ClickEvent:
    ...
    def serialize(self):
        ...
        # See: https://fastavro.readthedocs.io/en/latest/schema.html?highlight=parse_schema#fastavro-schema
        # HINT: Python dataclasses provide an `asdict` method that can quickly transform this instance into a dictionary!
        # See: https://docs.python.org/3/library/dataclasses.html#dataclasses.asdict
        # HINT: Use BytesIO for your output buffer. Once you have an output buffer instance, call `getvalue() to retrieve the data inside the buffer.
