...
# It doens't matter _how_ you score the incoming records,
# just perform some modification of the `ClickEvent.score` field and return the value
def add_score(clickevent):
    clickevent.score = random.randint(0, 10)
    return clickevent
